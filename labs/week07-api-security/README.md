# Week 7 — API Security  (Practical Exam #1)
...
4. **Fix:** object-level auth checks, explicit allow-listed request schemas, and rate limiting.

## Deliverable + Exam
Findings report (API Top 10 mapping) + fixes. A timed CTF-style flag hunt is graded as Practical Exam #1.
