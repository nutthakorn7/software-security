# Weekly Quiz — Week 1 (Threat Modeling)
...
5. An uploaded filename `../../etc/passwd` is an attempt at:
   a) XSS  b) path traversal (information disclosure)  c) SQLi  d) DoSA
ANS b.
## Short answer (1 × 3)
6. In one sentence, what is the difference between a **use case** and a **misuse case**?
ANS A use case describes how a legitimate user is intended to use the system, while a misuse case describes how an attacker or unauthorized user could abuse the system.
